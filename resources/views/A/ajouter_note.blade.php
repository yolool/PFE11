...
<body>
    ...
    <form action="{{ route('notes.store', ['stagiaire_id' => $stagiaire->id]) }}" method="POST">
        @csrf
        <input type="hidden" name="stagiaire_id" value="{{ $stagiaire->id }}">
        <label for="cc1">CC1:</label>
        <input type="text" id="cc1" name="cc1">
        <label for="cc2">CC2:</label>
        <input type="text" id="cc2" name="cc2">
        <label for="cc3">CC3:</label>
        <input type="text" id="cc3" name="cc3">
